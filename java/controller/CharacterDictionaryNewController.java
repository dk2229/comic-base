...
@WebServlet("/characterDictionaryNew")
public class CharacterDictionaryNewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("/jsp/characterDictionaryNew.jsp");
